                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-9 col-md-9 px-0 mb-1 col-sm-9">
                                                                ...
                                                                <p class="fs-13 text-white">Vaddukottai-Moolai Road, Moolai, Srilanka
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-6 col-md-9 px-0 mb-1 col-sm-9">
                                                                ...
                                                                <p class="mb-0 fs-13 text-white">021-2224528
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-9 col-md-9 px-0 mb-1 col-sm-9">
                                                                ...
                                                                <p class="mb-0 fs-13 text-white">contact@akshayatravels.com
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
