	...
	<div class="container px-5 px-md-0">
		<div class="d-flex justify-content-center align-items-center">
			<div class="col-lg-12 col-md-12">
				<div class="card">
					<div class="card-body">
						<form class="needs-validation  text-white" name="contact-formApplication" novalidate>
							<!-- @csrf -->
							<div class="form-row">
							...
							<div class="form-row">
								<div class="col-md-4 mb-3">
									<label for="type">Travel's Type<i style="color: red;"> *</i></label>
								...
								<div class="col-md-4 mb-3">
									<label for="travellers">No of Travellers<i style="color: red;"> *</i></label>
